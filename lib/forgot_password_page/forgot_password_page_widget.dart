import 'package:paw_fect_care/forgot_password_with_fields/forgot_password_with_fields_widget.dart';
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: 'Your email reset code...',
                        labelStyle:
                            FlutterFlowTheme.of(context).labelMedium.override(
                                  font: GoogleFonts.plusJakartaSans(
                                    fontWeight: FontWeight.w500,
                        ...
                        hintText: 'Your email reset code...',
                        hintStyle:
                            FlutterFlowTheme.of(context).labelMedium.override(
                                  font: GoogleFonts.plusJakartaSans(
                                    fontWeight: FontWeight.w500,
                      ...
                      keyboardType: TextInputType.emailAddress,
                      cursorColor: Color(0xFF6F61EF),
                      validator: _model.codefIELDTextControllerValidator
                          .asValidator(context),
                    ),
                  ),
                ),
              if (_model.codeIsInvalid)
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        _model.apiResultk2q = await ForgotPasswordCall.call(
                          email: _model.emailAddressTextController.text,
                          url: 'PawFectCare://email-confirmed',
                          accessToken: FFAppState().accessToken,
                        );

                        _shouldSetState = true;
                        if ((_model.apiResultk2q?.succeeded ?? true)) {
                          _model.sent = true;
                          safeSetState(() {});
                        } else {
              ...
              if (_model.sent)
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        if (_model.codefIELDTextController.text ==
                            'A7X9-KD3P-4ZQW') {
                          _model.codeIsInvalid = false;
                          safeSetState(() {});

                          context.pushNamed(
                              ForgotPasswordWithFieldsWidget.routeName);
                        } else {
                          _model.codeIsInvalid = true;
                          safeSetState(() {});
                        }
                      },
                      text: 'Submit',
